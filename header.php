<!DOCTYPE html>
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Kanit:400,600,700|Poppins:400,600,700&display=swap" rel="stylesheet">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-main" id="navbar-main">
                ...
                <a class="navbar-brand" href="index.php"><img src="images/logo@2x.png" alt=""></a>
